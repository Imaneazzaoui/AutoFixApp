...
import 'package:demo1/page-1/iphone-13-13-pro-22.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 19 * fem, 270 * fem),
                                constraints: BoxConstraints(
                                  maxWidth: 324 * fem,
                                ),
                                child: Text(
                                  'Each mechanic listed on AutoFix has a detailed profile that includes important information about the garage',
                                  style: SafeGoogleFont(
                                    'Inter',
                                    fontSize: 24 * ffem,
