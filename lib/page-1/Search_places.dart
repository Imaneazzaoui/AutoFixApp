...
const kGoogleApiKey = 'AIzaSyBdl4nNCZAiVRNlmHg5sAEsaJdUQ4GKLuU';
final homeScaffoldKey = GlobalKey<ScaffoldState>();

class _SearchPlacesScreenState extends State<SearchPlacesScreen> {
  static const CameraPosition initialCameraPosition = CameraPosition(target: LatLng(33.9716, -6.8498), zoom: 14.0);
